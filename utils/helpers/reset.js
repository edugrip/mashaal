module.exports = function(email, link) {
  ...
  html += '<h2 style="font-size:30px; text-align:center"><b> Reset your password?\n</b></h2>\n';
  html +=
    '<p style="color:#fff">If you requested a password reset for ' +
    username +
    ', click the button below. If you didnt make this request, ignore this email.</p>';

  html +=
    '<h3><a style="color: #fff; background: rgba(0, 146, 255, 0.86);padding: 20px;margin: 0px auto;text-align: center;display: list-item;font-size: 25px;text-decoration: none;" href="' +
    link +
    '" style=' +
    btnstyle +
    '>Reset password </button></h3>';
