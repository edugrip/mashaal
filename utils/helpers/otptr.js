module.exports = function(email, otp) {
  ...
  html += '<h2 style="color:#fff"><b>High security OTP to complete your transaction.\n</b></h2>\n';
  html += '<h3 style="color:#fff; font-size:36px; text-align:center">' + otp + '</h3>';
  html +=
    '<p style="color:#fff">Please make sure that links start with “https://” and contain <a  style="color:#fff; text-decoration:underline" href="https://tccworld.org">tccworld.org</a>. Your browser will also display a padlock icon to let you know a site is secure.</p>	';
  html += '</div>';
  html += '</div>';
  return html;
};
